...
- [ ] 04.4-02-PLAN.md — Log level migration (logInfo to logDebug for per-operation entry/exit across 8 files)
...
- [x] 04.3-02-PLAN.md -- Smart scroll behavior, draft input, tab switch scroll preservation in chat panel
- [x] 04.3-03-PLAN.md -- SessionStatusIndicator tool-input extension, ConcurrencyWarningBanner, sidebar wiring
- [x] 04.3-04-PLAN.md -- Gap closure: fix unread indicator (null tabKey guard + clear unread on tab switch)
