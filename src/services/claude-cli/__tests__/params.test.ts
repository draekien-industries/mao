...
describe("buildArgs", () => {
  ...
  it("--model", async () => {
    ...
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", model: "claude-opus-4-6" }),
      QueryParams,
    );
  ...
  it("--append-system-prompt", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", append_system_prompt: "Be brief" }),
      QueryParams,
    );
  ...
  it("--allowedTools (variadic)", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", allowed_tools: ["Read", "Write"] }),
      QueryParams,
    );
  ...
  it("empty allowed_tools does NOT emit --allowedTools", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", allowed_tools: [] }),
      QueryParams,
    );
  ...
  it("--max-turns", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", max_turns: 5 }),
      QueryParams,
    );
  ...
  it("--max-budget-usd", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", max_budget_usd: 0.5 }),
      QueryParams,
    );
  ...
  it("--bare when true", async () => {
    ...
    const { QueryParams } = await import("../params");
    expect(
      buildArgs(new QueryParams({ prompt: "Hi", bare: true }), QueryParams),
    ).toContain("--bare");
  });
  ...
  it("no --bare when false", async () => {
    ...
    const { QueryParams } = await import("../params");
    expect(
      buildArgs(new QueryParams({ prompt: "Hi", bare: false }), QueryParams),
    ).not.toContain("--bare");
  });
  ...
  it("--session-id", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", session_id: "sess_01" }),
      QueryParams,
    );
  ...
  it("--name", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", name: "my-session" }),
      QueryParams,
    );
  ...
  it("--max-turns with value 0 (undefined guard, not falsy)", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", max_turns: 0 }),
      QueryParams,
    );
    expect(args).toContain("--max-turns");
  ...
  it("--max-budget-usd with value 0 (undefined guard, not falsy)", async () => {
    ...
    const { QueryParams } = await import("../params");
    const args = buildArgs(
      new QueryParams({ prompt: "Hi", max_budget_usd: 0 }),
      QueryParams,
    );
    expect(args).toContain("--max-budget-usd");
    expect(args).toContain("0");
  ...
  it("all classes emit base flags from commandFlags", async () => {
    ...
    const r = buildArgs(
      new ResumeParams({ prompt: "Hi", session_id: "sess_01" }),
      ResumeParams,
    );
  ...
  it("ResumeParams with fork: true emits --fork-session", async () => {
    ...
    const { ResumeParams } = await import("../params");
    const args = buildArgs(
      new ResumeParams({ prompt: "Hi", session_id: "sess_01", fork: true }),
      ResumeParams,
    );
  ...
  it("ResumeParams with fork: false does NOT emit --fork-session", async () => {
    ...
    const { ResumeParams } = await import("../params");
    const args = buildArgs(
      new ResumeParams({ prompt: "Hi", session_id: "sess_01", fork: false }),
      ResumeParams,
    );
